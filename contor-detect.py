...
try:
    ...
    print "No num py libraties found!! need Numpy for Python!!."
    exit()

try: import cv2
except:
    print "open cv libraries not found!!  need OpenCV for Python!!."
    exit()

# check if latest version of open cv is installed
if not cv2.__version__ >= "2.4":
    print "OpenCV version too old!!."
    print "you wneed version  2.4 or above"
    exit()
for *buntu systems only
